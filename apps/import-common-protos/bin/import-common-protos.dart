...
void main(List<String> arguments) async {
  ...
  // This assumes the common protos repo is checked out in ~/Desktop/api-common-protos
  String root =
      (Platform.environment['HOME'] ?? "") + '/Desktop/api-common-protos';
  ...
  List<Entry> entries = [
    ...
    Entry()
      ...
      ..description = "Administration API for Identity and Access Management.",
    Entry()
